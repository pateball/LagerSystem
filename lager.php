		...
		<div class="container-fluid">
			<table class="table table-bordered table-condensed table-hover table-striped"><br><br>
				...
				<tr>
					...
					<td><?php echo $row['lagerort'] ?><div class="text-right"><button type="button" class="btn btn-danger text-right"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></div></td>	
				</tr>
					<?php }} ?>
			</table>
			<?php
